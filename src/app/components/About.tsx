  ...
  return (
    ...
    >
      <div className="m-3 flex flex-col md:flex-row justify-between md:items-center">
        <h3 className="tracking-tighter font-inconsolata text-red-800 min-w-[8rem] font-bold text-3xl">What Is Our Aim?</h3>
      ...
      <div className="my-10 flex flex-col md:flex-row justify-between md:items-center">
        ...
        <p className="text-red-700 mt-4 md:mt-0 tracking-tighter font-inconsolata">See Our Reviews</p>
      </div>
      <div className="flex flex-col justify-between lg:flex-row">
        {data.map((item, index) => (
          <div key={index} className="m-4 md:m-8">
            <h3 className="tracking-tighter font-inconsolata text-red-800 font-bold text-3xl">{item.title}</h3>
