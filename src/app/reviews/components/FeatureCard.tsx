      ...
      <Link href={`/`}>
        ...
        <div className="relative w-[10rem] sm:w-[14rem] md:w-[22rem] lg:w-[26rem] 2xl:h-[20rem]">
          ...
          <div className= "text-left font-bold m-6 2xl:m-10 flex flex-col justify-between">
            ...
            <p className="text-regal tracking-tighter font-inconsolata text-md md:text-lg xl:text-2xl mt-4">{post.subheading}</p>
            </div>
            <div className="mt-24">
              <p className="text-stone-500 tracking-tighter font-inconsolata text-xs md:text-sm">Read Full Article</p>
            </div>
          </div>
        </div>
      </Link>
